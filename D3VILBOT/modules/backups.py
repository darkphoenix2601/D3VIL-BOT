...
import D3VILBOT.modules.sql.notes_sql as sql
from D3VILBOT import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from D3VILBOT.__main__ import DATA_IMPORT
from D3VILBOT.modules.helper_funcs.chat_status import user_admin
from D3VILBOT.modules.helper_funcs.alternate import typing_action

# from D3VILBOT.modules.rules import get_rules
import D3VILBOT.modules.sql.rules_sql as rulessql

# from D3VILBOT.modules.sql import warns_sql as warnssql
import D3VILBOT.modules.sql.blacklist_sql as blacklistsql
from D3VILBOT.modules.sql import disable_sql as disabledsql

# from D3VILBOT.modules.sql import cust_filters_sql as filtersql
# import D3VILBOT.modules.sql.welcome_sql as welcsql
import D3VILBOT.modules.sql.locks_sql as locksql
from D3VILBOT.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("D3VILBOT{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("D3VILBOT{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `D3VILBOT-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("D3VILBOT{}.backup".format(chat_id))  # Cleaning file
