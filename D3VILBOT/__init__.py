...
if ENV:
    ...
    from D3VILBOT.config import Development as Config
...
pbot = Client("D3VILBOT", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from D3VILBOT.modules.helper_funcs.handlers import (
